...
corp6 = tm_map(corp5, content_transformer(tolower), lazy=TRUE) 
corp6 = tm_map(corp5, content_transformer(removeWords), c("TIL") ,lazy=TRUE) 
corp6 = tm_map(corp5, stripWhitespace)
corp6 = tm_map(corp5, content_transformer(removeWords), stopwords("SMART"), lazy=TRUE)
